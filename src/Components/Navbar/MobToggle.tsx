...
export default function MobToggle() {
  ...
  const classNames = `absolute bg-white mt-14  w-4/5 shadow-lg justify-between ${isOpen ? '' : 'opacity-0'}`;
  const handleClick = () => {
    ...
    <>
      ...
      ><CloseIcon />
        ...
        <ul className='sm:hidden mb-5' >
          ...
          <li className='px-4  p-3 border-b  border-gray-300 '><Link href='/shop' className='transform transition duration-500 relative text-xl w-fit block after:block after:absolute after:h-[3px] after:bg-orange-800  after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center hover:text-orange-800'>Shop All</Link> </li>
          <li className='px-4  p-3 border-b  border-gray-300 '><Dropdown screen="mob"/></li>
